...
{{--
    File ini di-include HANYA jika $isWaliKelas = true (sudah di-guard di dashboard.blade.php).
    Guard @if($isWK) di sini adalah safety net layer ke-2.
--}}
@php
    ...
    <div style="background:linear-gradient(135deg,#fffbeb 0%,#fef3c7 100%);
        ...
        <div style="display:flex;align-items:center;gap:8px;">
            ...
            <div style="background:rgba(217,119,6,.18);border:1px solid rgba(217,119,6,.35);
                ...
                <span style="font-size:.95rem;font-weight:800;color:#92400e;display:block;line-height:1.1;">
                    {{ $jmlSiswa }}
                </span>
                <span style="font-size:.5rem;color:#a16207;font-weight:600;display:block;
                             text-transform:uppercase;letter-spacing:.04em;">siswa</span>
            </div>
        </div>
    </div>
    ...
    <div style="padding:12px 14px;display:flex;flex-direction:column;gap:10px;">
        ...
        <div>
            <p style="font-size:.58rem;font-weight:700;color:#64748b;text-transform:uppercase;
                      letter-spacing:.06em;margin:0 0 6px;">Kehadiran {{ $bulanNm }}</p>
            ...
            @elseif(!$adaDataAbsensi)
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;
                    ...
                    <span style="font-size:.62rem;font-weight:600;color:#64748b;">Belum Absensi</span>
                    <span style="font-size:.72rem;font-weight:800;color:#64748b;">
                        {{ $jmlSiswa }} <span style="font-size:.52rem;font-weight:600;">siswa</span>
                    </span>
                </div>
            ...
            @else
                ...
                <div style="margin-top:6px;padding:7px 10px;background:#f8fafc;
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px;">
                        <p style="font-size:.57rem;font-weight:600;color:#64748b;margin:0;">Est. Rata-rata Kelas</p>
                        <p style="font-size:.72rem;font-weight:800;color:{{ $avgColor }};margin:0;">~{{ $avgPct }}%</p>
                    </div>
        ...
        {{-- Quick Links --}}
        <div style="display:flex;flex-direction:column;gap:5px;padding-top:8px;border-top:1px solid #f1f5f9;">
            ...
            <a href="{{ route('guru.wali-kelas') }}"
               ...
               onmouseout="this.style.background='#fffbeb'">
                <span style="font-size:.8rem;">👥</span> Data Kelas Saya
            </a>
            @endif
            ...
            <a href="{{ route('guru.absensi-siswa.rekap', ['kelas_id' => $kelasWali->id]) }}"
               ...
               onmouseout="this.style.background='#eef2ff'">
                <span style="font-size:.8rem;">📊</span> Rekap Absensi Kelas
            </a>
            @endif
            ...
            <a href="{{ route('guru.absensi-siswa.index', $kelasWali ? ['kelas_id' => $kelasWali->id] : []) }}"
               ...
               onmouseout="this.style.background='#ecfdf5'">
                <span style="font-size:.8rem;">✅</span> Catat Absensi Hari Ini
            </a>
            @endif
