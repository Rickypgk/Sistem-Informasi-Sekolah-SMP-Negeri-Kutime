        ...
        <table class="w-full">
            <thead>
                <tr class="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700 text-left">
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide w-7">#</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[180px]">Guru</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[110px]">NIP</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Kelamin</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[130px]">Tempat / Tgl Lahir</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[90px]">Pendidikan</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[100px]">Status</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[120px]">Pangkat/Gol</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[120px]">No. SK Pertama</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[120px]">No. SK Terakhir</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide min-w-[90px]">Wali Kelas</th>
                    <th class="px-3 py-2.5 text-[10px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide text-center min-w-[90px]">Aksi</th>
                </tr>
            </thead>
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/20 transition-colors searchable-row">
                        ...
                        <td class="px-3 py-2.5">
                            @if($g && $g->jk)
                                <span class="inline-flex px-1.5 py-0.5 rounded-full text-[10px] font-semibold
                                             {{ $g->jk==='L' ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-pink-50 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400' }}">
                                    {{ $g->jk==='L' ? '♂ L' : '♀ P' }}
                                </span>
                            @else
                                <span class="text-slate-300 dark:text-slate-600 text-[10px]">—</span>
                        ...
                        <td class="px-3 py-2.5">
                            @if($g && ($g->tempat_lahir || $g->tanggal_lahir))
                                ...
                                <p class="text-[10px] text-slate-400">
                                    {{ $g->tanggal_lahir ? $g->tanggal_lahir->translatedFormat('d F Y') : '-' }}
                                </p>
                            @else
                                <span class="text-slate-300 dark:text-slate-600 text-[10px]">—</span>
                            @endif
                        ...
                        <td class="px-3 py-2.5">
                            @if($g && $g->no_sk_pertama)
                                <span class="font-mono text-[10px] text-slate-600 dark:text-slate-400">{{ $g->no_sk_pertama }}</span>
                            @else
                                <span class="text-slate-300 dark:text-slate-600 text-[10px]">—</span>
                            @endif
                        </td>
                        ...
                        <td class="px-3 py-2.5">
                            @if($g && $g->no_sk_terakhir)
                                <span class="font-mono text-[10px] text-slate-600 dark:text-slate-400">{{ $g->no_sk_terakhir }}</span>
                            @else
                                <span class="text-slate-300 dark:text-slate-600 text-[10px]">—</span>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td colspan="12" class="px-4 py-12 text-center">
                            <div class="flex flex-col items-center gap-2 text-slate-400">
                                ...
                                <div>
                                    <p class="text-xs font-semibold text-slate-500 dark:text-slate-400">Belum ada data guru</p>
