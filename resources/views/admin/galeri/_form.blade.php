{{--
    ...
    Partial — dipakai di dalam modal overlay (bukan halaman penuh).
    Variabel yang dibutuhkan:
      - $galeri          → model Galeri (null = mode tambah)
      - $tipeOptions     → array tipe media
      - $kategoriOptions → array kategori
--}}
<div
    x-data="galeriForm('{{ old('tipe', $galeri->tipe ?? 'photo') }}')"
    id="galeri-form-inner"
>
    @if($errors->any())
    ...
    >
        ...
        <div class="flex items-center justify-between pt-3 border-t border-slate-200">
            <button
                type="button"
                @click="$dispatch('close-galeri-modal')"
