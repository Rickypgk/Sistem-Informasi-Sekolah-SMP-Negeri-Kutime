...
<div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200
    ...
    <div class="flex items-center justify-between px-4 py-3
        ...
        <span class="text-[10px] font-bold text-amber-600 dark:text-amber-400
            ...
            <?php echo e(collect($jadwalHariIni)->count()); ?> sesi
        </span>
    </div>

    
    <?php if(collect($jadwalHariIni)->isEmpty()): ?>
    ...
    <?php else: ?>
        <div class="overflow-y-auto max-h-[380px]
            ...
            <div class="relative px-4 py-3 space-y-1">
                ...
                <?php $__currentLoopData = collect($jadwalHariIni); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="flex items-center gap-3 px-3 py-2.5 rounded-xl border
                            <?php echo e($rowBg); ?> transition-all">

                    
                    <div class="flex flex-col items-center shrink-0 w-12 gap-0.5">
                        <span class="w-2 h-2 rounded-full <?php echo e($dotColor); ?> shrink-0
                                     <?php echo e($isNow ? 'animate-pulse' : ''); ?>"></span>
                        <span class="text-[9px] font-bold text-slate-600 dark:text-slate-400
                                     font-mono leading-none"><?php echo e($startStr); ?></span>
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-xs font-semibold text-slate-800 dark:text-slate-100
                            ...
                            <?php echo e($jadwal->guru_nama ?? '—'); ?>

                        </p>
                        <p class="text-[10px] text-slate-400 truncate leading-tight mt-0.5">
                            <?php echo e($jadwal->subject ?? 'Mata Pelajaran'); ?>

                            <?php if($jadwal->room ?? null): ?>
                                · <?php echo e($jadwal->room); ?>
                    ...
                    <span class="text-[10px] font-bold px-2 py-0.5 rounded-lg
                                 <?php echo e($kelasColor); ?> shrink-0 whitespace-nowrap">
                        <?php echo e($jadwal->kelas_nama ?? '—'); ?>
    ...
    <?php if(Route::has('admin.jadwal.index') && collect($jadwalHariIni)->isNotEmpty()): ?>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\PA 3\smpn-kutime\resources\views/admin/dashboard/schedule.blade.php ENDPATH**/ ?>