                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/20
                            ...
                            <td class="px-3 py-2.5">
                                <div class="flex items-center justify-center gap-0.5">
                                    ...
                                    <button onclick="openEditModal(<?php echo e($k->id); ?>)"
                                            title="Edit Kelas"
                                            class="p-1.5 rounded-lg text-slate-400
...
function openEditModal(kelasId) {
    ...
    document.getElementById('formEditKelas').action = '<?php echo e(url("admin/kelas")); ?>/' + kelasId;
...
function openDeleteModal(kelasId, kelasNama) {
    ...
    document.getElementById('formHapusKelas').action = '<?php echo e(url("admin/kelas")); ?>/' + kelasId;
