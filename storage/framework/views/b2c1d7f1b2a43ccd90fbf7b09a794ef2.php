                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/20
                            ...
                            <td class="px-3 py-2.5">
                                <?php if($s?->nik): ?>
                                    <span class="font-mono text-[10px] text-slate-600
                                                 dark:text-slate-400"><?php echo e($s->nik); ?></span>
                                <?php else: ?>
                                    <span class="text-slate-300 dark:text-slate-600
                                                 text-[10px]">—</span>
                                <?php endif; ?>
                            ...
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->agama ?? '—'); ?></td>
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->no_telp ?? '—'); ?></td>

                            
                            <td class="px-3 py-2.5">
                                <?php if($s?->shkun): ?>
                                    <span class="font-mono text-[10px] text-slate-600
                                                 dark:text-slate-400"><?php echo e($s->shkun); ?></span>
                                <?php else: ?>
                                    <span class="text-slate-300 dark:text-slate-600
                                                 text-[10px]">—</span>
                                <?php endif; ?>
                            ...
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->rt ?? '—'); ?></td>
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->rw ?? '—'); ?></td>
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->dusun ?? '—'); ?></td>
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->kecamatan ?? '—'); ?></td>
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->kode_pos ?? '—'); ?></td>
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->jenis_tinggal ?? '—'); ?></td>
                            <td class="px-3 py-2.5 text-[10px] text-slate-600
                                       dark:text-slate-400"><?php echo e($s?->jalan_transportasi ?? '—'); ?></td>
                            ...
                            <td class="px-3 py-2.5">
                                <?php if($s?->no_kps): ?>
                                    <span class="font-mono text-[10px] text-slate-600
                                                 dark:text-slate-400"><?php echo e($s->no_kps); ?></span>
                                <?php else: ?>
                                    <span class="text-slate-300 dark:text-slate-600
                                                 text-[10px]">—</span>
                                <?php endif; ?>
                            ...
                            <td class="px-3 py-2.5">
                                <div class="flex items-center justify-center gap-0.5">
                                    <button onclick="openDetailModal(<?php echo e($user->id); ?>)"
                                            title="Lihat Detail"
                                    ...
                                    <button onclick="openResetModal(<?php echo e($user->id); ?>,
                                                '<?php echo e(addslashes($s?->nama ?? $user->name)); ?>')"
                                    ...
                                    <button onclick="openDeleteModal(<?php echo e($user->id); ?>,
                                                '<?php echo e(addslashes($s?->nama ?? $user->name)); ?>')"
                                            title="Hapus User"
                                            class="p-1.5 rounded-lg text-slate-400
