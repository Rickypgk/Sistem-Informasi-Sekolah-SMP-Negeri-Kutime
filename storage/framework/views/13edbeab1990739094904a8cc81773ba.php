<div class="relative overflow-hidden rounded-2xl px-6 py-6 text-white shadow-lg"
    ...
    <div class="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="shrink-0 rounded-xl px-4 py-3 text-center border bg-white/15 border-white/20">
            <p class="text-lg font-bold leading-none"><?php echo e(now()->isoFormat('D MMM')); ?></p>
            <p class="text-violet-200 text-xs mt-1"><?php echo e(now()->isoFormat('Y')); ?></p>
        </div>
    </div>
</div><?php /**PATH C:\PA 3\smpn-kutime\resources\views/guru/dashboard/header.blade.php ENDPATH**/ ?>