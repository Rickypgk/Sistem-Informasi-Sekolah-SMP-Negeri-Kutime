    ...
    <div style="padding:12px 14px;display:flex;flex-direction:column;gap:10px;">
        ...
        <div>
            <p style="font-size:.58rem;font-weight:700;color:#64748b;text-transform:uppercase;
                      letter-spacing:.06em;margin:0 0 6px;">Kehadiran <?php echo e($bulanNm); ?></p>
            ...
            <?php elseif(!$adaDataAbsensi): ?>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;
                    ...
                    <span style="font-size:.72rem;font-weight:800;color:#64748b;">
                        <?php echo e($jmlSiswa); ?> <span style="font-size:.52rem;font-weight:600;">siswa</span>
                    </span>
                </div>
            ...
            <?php else: ?>
                ...
                <div style="margin-top:6px;padding:7px 10px;background:#f8fafc;
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px;">
                        ...
                        <p style="font-size:.72rem;font-weight:800;color:<?php echo e($avgColor); ?>;margin:0;">~<?php echo e($avgPct); ?>%</p>
                    </div>
