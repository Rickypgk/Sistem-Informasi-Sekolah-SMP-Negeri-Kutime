                ...
                <?php if(old('media_tipe')): ?>
                    ...
                    this.$nextTick(() => {
                        <?php if(old('media_link')): ?>
                            ...
                            if (ytEl) ytEl.value = <?php echo \Illuminate\Support\Js::from(old('media_link'))->toHtml() ?>;
                            if (fbEl) fbEl.value = <?php echo \Illuminate\Support\Js::from(old('media_link'))->toHtml() ?>;
...
</script><?php /**PATH C:\PA 3\smpn-kutime\resources\views/admin/kelola-website/tabs/berita.blade.php ENDPATH**/ ?>